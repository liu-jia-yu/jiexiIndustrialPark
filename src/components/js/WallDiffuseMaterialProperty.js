...
//     `
    ...
    // if(st.t>=0.0 && st.t <= 0.5){
    //   material.diffuse = color.rgb * (st.t+0.3);
    // }
    // else if(st.t>=0.5 && st.t <= 1.0){
    //   material.diffuse = color.rgb / (st.t+0.7);
    // }else{
    ...
    material.alpha = color.a * (1.0 - fract(st.t)) * 0.4;
    return material;
    }
