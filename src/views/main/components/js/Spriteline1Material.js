...
let Spriteline1Type = 'Spriteline1'
let Spriteline1Source = `
...
Cesium.Material._materialCache.addMaterial(Spriteline1Type, {
  fabric: {
    type: Spriteline1Type,
    uniforms: {
